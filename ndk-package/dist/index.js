...
var Zap = class extends import_tseep3.EventEmitter {
  ndk;
  zappedEvent;
  zappedUser;
  constructor(args) {
...
var NDKUser = class _NDKUser {
  ...
  get npub() {
    if (!this._npub) {
      ...
      this._npub = import_nostr_tools8.nip19.npubEncode(this.pubkey);
    }
    return this._npub;
  }
  set npub(npub) {
  ...
  get pubkey() {
    if (!this._pubkey) {
      ...
      this._pubkey = import_nostr_tools8.nip19.decode(this.npub).data;
    }
    return this._pubkey;
  }
  /**
...
var NDKNostrRpc = class extends import_tseep6.EventEmitter {
  ndk;
  signer;
  debug;
...
var NDKPool = class extends import_tseep9.EventEmitter {
