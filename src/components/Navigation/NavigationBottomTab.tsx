...
const NavigationBottomTab: React.FC<NavigationBottomTabProps> = ({
  ...
  return (
    <>
      <div
        className={`absolute bottom-24 right-6 p-3 z-20 bg-blue-500 active:bg-blue-600 rounded-full drop-shadow-[0_2px_2px_rgba(0,0,0,0.25)] transition-opacity duration-200 ${shouldFocusBottomTab ? 'opacity-50' : 'opacity-100'}`}
